...
export class Init1592387596271 implements MigrationInterface {
    name = 'Init1592387596271'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "monitored-result" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "statusCode" integer NOT NULL, "payload" character varying NOT NULL, "checkedAt" TIMESTAMP WITH TIME ZONE, "monitoredEndpointId" uuid, CONSTRAINT "PK_a81ef84ac90153e8a1d080d72f8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "monitored-endpoint" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "name" character varying NOT NULL, "url" character varying NOT NULL, "monitoredInterval" integer NOT NULL, "disabled" boolean NOT NULL DEFAULT false, "checkedAt" TIMESTAMP WITH TIME ZONE, "ownerId" uuid, CONSTRAINT "PK_62a2c228026316665d87925c2ab" PRIMARY KEY ("id"))`);
